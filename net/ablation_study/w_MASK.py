...
class ConvLSTMCell(nn.Module):
    ...
    def forward(self, input_tensor1, input_tensor2, input_tensor3, cur_state, A):
        ...
        input_tensor1 = input_tensor1.contiguous().view(n, -1)
        input_tensor2 = input_tensor2.contiguous().view(n, -1)
        input_tensor3 = input_tensor3.contiguous().view(n, -1)
